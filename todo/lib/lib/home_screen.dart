...
import 'package:mod8asgmt/data/data_base.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  TaskManagerDataBase DataBase = TaskManagerDataBase();
    ...
    return Scaffold(
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) {
          final task = DataBase.tasks[index];
          return Container(
            child: Container(
              ...
              child: ListTile(
                  ...
                  subtitle: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          DataBase.tasks[index].description,
                          style: TextStyle(
                            fontSize: 15,
                            color: task.isChecked ? Colors.grey : Colors.white,
                            decoration: task.isChecked
                  ...
                  onLongPress: () {
                    _openTaskDetails(DataBase.tasks[index], index);
                  }),
            ),
          );
        },
