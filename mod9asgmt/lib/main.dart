...
class _WeatherAppState extends State<WeatherApp> {
  ...
  //   final currentTime = DateTime(now.year, now.month, now.day, now.hour);
  //   final sunriseTime =
  //       DateTime.fromMillisecondsSinceEpoch(int.parse(_sunrise) * 1000);
  //   final sunsetTime =
  //       DateTime.fromMillisecondsSinceEpoch(int.parse(_sunset) * 1000);
  ...
  //         image: AssetImage(
  //             'assets/night.png'), // Set your desired day background image
  //         fit: BoxFit.cover,
  //       ),
  //     );
  //   } else {
